...
import { RippleButton } from "@/components/landing/ui/multi-type-ripple-buttons";
...
export const PricingCard = ({
  ...
  const cardClasses = `
    bg-gradient-to-br rounded-2xl shadow-xl flex-1 max-w-xs px-7 py-8 flex flex-col transition-colors duration-200
